...
export default function AWSCertificationCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new AWSCertification(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "AWSCertificationCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"

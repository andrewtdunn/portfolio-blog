...
export default function MiscCertificationUpdateForm(props) {
  const {
    id: idProp,
    miscCertification: miscCertificationModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = miscCertificationRecord
      ? { ...initialValues, ...miscCertificationRecord }
      : initialValues;
  ...
  const [miscCertificationRecord, setMiscCertificationRecord] = React.useState(
    miscCertificationModelProp
  );
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(MiscCertification, idProp)
        : miscCertificationModelProp;
      setMiscCertificationRecord(record);
    };
    queryData();
  }, [idProp, miscCertificationModelProp]);
  React.useEffect(resetStateValues, [miscCertificationRecord]);
  const validations = {
    name: [],
    link: [],
    image: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            MiscCertification.copyOf(miscCertificationRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "MiscCertificationUpdateForm")}
      {...rest}
    >
      <TextField
        label="Name"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || miscCertificationModelProp)}

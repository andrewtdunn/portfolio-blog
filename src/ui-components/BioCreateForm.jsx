...
export default function BioCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setIntroClosing(initialValues.introClosing);
    setSignatureImage(initialValues.signatureImage);
    setMainUser(initialValues.mainUser);
    setErrors({});
  };
  const validations = {
    image: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Bio(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "BioCreateForm")}
      {...rest}
    >
      <TextField
        label="Image"
